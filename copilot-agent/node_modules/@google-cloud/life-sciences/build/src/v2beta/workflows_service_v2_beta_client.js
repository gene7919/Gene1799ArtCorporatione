...
exports.WorkflowsServiceV2BetaClient = void 0;
 ...
 */
const gapicConfig = require("./workflows_service_v2_beta_client_config.json");
...
class WorkflowsServiceV2BetaClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('life-sciences');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        const runPipelineResponse = protoFilesRoot.lookup('.google.cloud.lifesciences.v2beta.RunPipelineResponse');
        const runPipelineMetadata = protoFilesRoot.lookup('.google.cloud.lifesciences.v2beta.Metadata');
        this.descriptors.longrunning = {
            runPipeline: new this._gaxModule.LongrunningDescriptor(this.operationsClient, runPipelineResponse.decode.bind(runPipelineResponse), runPipelineMetadata.decode.bind(runPipelineMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.workflowsServiceV2BetaStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.lifesciences.v2beta.WorkflowsServiceV2Beta, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of workflowsServiceV2BetaStubMethods) {
            const callPromise = this.workflowsServiceV2BetaStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    async checkRunPipelineProgress(name) {
...
exports.WorkflowsServiceV2BetaClient = WorkflowsServiceV2BetaClient;
//# sourceMappingURL=workflows_service_v2_beta_client.js.map